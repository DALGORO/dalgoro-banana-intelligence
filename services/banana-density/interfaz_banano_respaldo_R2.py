...
BUILD_ID = "DALGORO_BANANA_GUI_V1_20260717_R2"
...
def validate_values(values: dict[str, Any]) -> None:
    ...
    if bool(exclusions_gpkg) != bool(exclusions_layer):
        raise ValueError(
            "La ruta y el nombre de la capa de exclusiones "
            "deben completarse juntos."
        )
...
class BananaAnalyzerApp(tk.Tk):
    ...
    def _build_data_tab(self) -> None:
        ...
        tk.Label(
            exclusion,
            text=(
                "Deje ambos campos vacíos cuando todavía no existan "
                "vías, canales o infraestructura digitalizados."
            ),
            bg=BRAND_WHITE,
            fg="#6B7773",
            font=("Segoe UI", 8),
