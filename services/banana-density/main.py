...
from banana_analyzer.pipeline_orchestrator import (
    ALL_STAGE_KEYS,
    PROCESS_STAGE_KEYS,
    run_full_pipeline,
)
...
def build_argument_parser() -> argparse.ArgumentParser:
    ...
    dedup_parser.add_argument(
        ...
        help=(
            ...
            "Valor predeterminado validado: 1.00."
        ),
    )
    ...
    pipeline_parser = subparsers.add_parser(
        "run-full-analysis",
        help=(
            "Ejecuta o reanuda automáticamente todas "
    ...
    pipeline_parser.add_argument(
        ...
        type=str,
        help=(
            "Archivo YAML con ortofoto, límite, modelo, "
            "densidad y parámetros del análisis."
        ),
    )
    ...
    pipeline_parser.add_argument(
        ...
        default=None,
        help=(
            "Carpeta de una ejecución previamente "
            "iniciada que debe reanudarse."
        ),
    )
    ...
    pipeline_parser.add_argument(
        "--from-stage",
        type=str,
        choices=PROCESS_STAGE_KEYS,
        default=None,
        help=(
            "Empieza desde una etapa concreta. "
            "Las salidas anteriores deben existir."
        ),
    )
    ...
    pipeline_parser.add_argument(
        ...
        default=None,
        help=(
            "Pausa el flujo después de completar "
            "la etapa indicada."
        ),
    )
    ...
    pipeline_parser.add_argument(
        ...
        default=None,
        help=(
            "Reprocesa una etapa y las posteriores. "
            "Puede indicarse más de una vez."
        ),
    )
    ...
    pipeline_parser.add_argument(
        ...
        action="store_true",
        help=(
            "Valida la configuración y muestra el plan "
            "sin procesar la ortofoto."
        ),
    )
...
def main() -> int:
    ...
    if arguments.command == "run-full-analysis":
        return run_full_pipeline(
            config_path=arguments.config_path,
            resume_run_directory=(
                arguments.resume_run
            ),
