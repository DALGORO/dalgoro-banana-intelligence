# -*- coding: utf-8 -*-
"""
AUDITOR V2 - Calidad de respuestas del bot DALGORO
...
def auditar():
    ...
    for idx, escenario in enumerate(escenarios, start=1):
        ...
        if actividad_esperada and actividad_final and actividad_final != actividad_esperada:
            alerta = {
        ...
        if actividad_esperada and not actividad_final:
            alerta = {
        ...
        if motivo_esperado and motivo_esperado not in ["consultor", "informacion"] and not motivo_final:
            alerta = {
        ...
        if hubo_cierre:
            ...
            if not obtener_fecha_estado(estado) or not obtener_hora_estado(estado):
                alerta = {
    ...
    Path("reporte_auditoria_v2.json").write_text(
    ...
    # Salida consola
    print("=" * 74)
    print("AUDITOR V2 - CALIDAD DE RESPUESTAS DALGORO")
    print("=" * 74)
    ...
    print("reporte_auditoria_v2.json")
    print("\nFin de auditoría.")
